...
(function(process) {
  !function(t, e) {
    ...
    function s(t, e, n) {
      for (var o in e)
        o in t ? "string" == typeof t[o] || t[o] instanceof String || "string" == typeof e[o] || e[o] instanceof String ? n && (t[o] = e[o]) : s(t[o], e[o], n) : t[o] = e[o];
      return t;
    }
    function a(t) {
      return t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
      ...
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t;
        ...
        x = function() {
          function t(t, e) {
            ...
            try {
              for (var s,
                  a = t[Symbol.iterator](); !(o = (s = a.next()).done) && (n.push(s.value), !e || n.length !== e); o = !0)
                ;
            } catch (t) {
              r = !0, i = t;
            } finally {
        ...
        w = function() {
          ...
          return t.prototype.init = function(t) {
            ...
            return new t(this.logger, v({prefix: this.prefix + ":" + e + ":"}, this.options));
          }, t;
        }(),
        O = new w,
        L = function() {
        ...
        C = function(t) {
          ...
          return m(e, t), e.prototype.addNamespaces = function(t) {
            ...
            var u = i(this.data, l) || {};
            r ? s(u, n, a) : u = v({}, u, n), o(this.data, l, u), this.emit("added", t, e, n);
        ...
        N = function(t) {
          ...
          return m(n, t), n.prototype.changeLanguage = function(t) {
            ...
            return void 0 !== this.resolve(t, e);
            ...
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            if ("object" !== (void 0 === e ? "undefined" : d(e)) && (e = this.options.overloadTranslationOptionHandler(arguments)), void 0 === t || null === t || "" === t)
              return "";
            ...
            if (a && "cimode" === a.toLowerCase()) {
              if (l) {
                return s + (e.nsSeparator || this.options.nsSeparator) + r;
              }
              return r;
            }
            var u = this.resolve(t, e),
                c = Object.prototype.toString.apply(u),
                p = ["[object Number]", "[object Function]", "[object RegExp]"],
                f = void 0 !== e.joinArrays ? e.joinArrays : this.options.joinArrays;
            if (u && "string" != typeof u && p.indexOf(c) < 0 && (!f || "[object Array]" !== c)) {
              if (!e.returnObjects && !this.options.returnObjects)
                return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(r, u, e) : "key '" + r + " (" + this.language + ")' returned an object instead of string.";
              if (e.keySeparator || this.options.keySeparator) {
                var h = "[object Array]" === c ? [] : {};
                for (var g in u)
                  Object.prototype.hasOwnProperty.call(u, g) && (h[g] = this.translate("" + r + n + g, v({}, e, {
                    joinArrays: !1,
                    ns: i
                  })));
                u = h;
              }
            } else if (f && "[object Array]" === c)
              (u = u.join(f)) && (u = this.extendTranslation(u, r, e));
            else {
              var y = !1,
                  m = !1;
              if (this.isValidLookup(u) || void 0 === e.defaultValue || (y = !0, u = e.defaultValue), this.isValidLookup(u) || (m = !0, u = r), m || y) {
                this.logger.log("missingKey", a, s, r, u);
                var b = [],
                ...
                this.options.saveMissing && (this.options.missingKeyHandler ? this.options.missingKeyHandler(b, s, r, u) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(b, s, r, u)), this.emit("missingKey", b, s, r, u);
              }
              u = this.extendTranslation(u, r, e), m && u === r && this.options.appendNamespaceToMissingKey && (u = s + ":" + r), m && this.options.parseMissingKeyHandler && (u = this.options.parseMissingKeyHandler(u));
            }
            return u;
          }, n.prototype.extendTranslation = function(t, e, n) {
            var o = this;
            n.interpolation && this.interpolator.init(v({}, n, {interpolation: v({}, this.options.interpolation, n.interpolation)}));
            var r = n.replace && "string" != typeof n.replace ? n.replace : n;
            this.options.interpolation.defaultVariables && (r = v({}, this.options.interpolation.defaultVariables, r)), t = this.interpolator.interpolate(t, r, n.lng || this.language), !1 !== n.nest && (t = this.interpolator.nest(t, function() {
              return o.translate.apply(o, arguments);
            }, n)), n.interpolation && this.interpolator.reset();
            var i = n.postProcess || this.options.postProcess,
                s = "string" == typeof i ? [i] : i;
            return void 0 !== t && s && s.length && !1 !== n.applyPostProcessor && (t = j.handle(s, t, e, n, this)), t;
        ...
        U = function() {
          function t(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            y(this, t), this.languageUtils = e, this.options = n, this.logger = O.create("pluralResolver"), this.rules = c();
          }
        ...
        M = function() {
          ...
          return e.prototype.init = function() {
            ...
            this.escapeValue = void 0 === e.escapeValue || e.escapeValue, this.prefix = e.prefix ? a(e.prefix) : e.prefixEscaped || "{{", this.suffix = e.suffix ? a(e.suffix) : e.suffixEscaped || "}}", this.formatSeparator = e.formatSeparator ? e.formatSeparator : e.formatSeparator || ",", this.unescapePrefix = e.unescapeSuffix ? "" : e.unescapePrefix || "-", this.unescapeSuffix = this.unescapePrefix ? "" : e.unescapeSuffix || "", this.nestingPrefix = e.nestingPrefix ? a(e.nestingPrefix) : e.nestingPrefixEscaped || a("$t("), this.nestingSuffix = e.nestingSuffix ? a(e.nestingSuffix) : e.nestingSuffixEscaped || a(")"), this.maxReplaces = e.maxReplaces ? e.maxReplaces : 1e3, this.resetRegExp();
            ...
            for (this.resetRegExp(), u = 0; (a = this.regexpUnescape.exec(e)) && (l = c(a[1].trim()), e = e.replace(a[0], l), this.regexpUnescape.lastIndex = 0, !(++u >= this.maxReplaces)); )
              ;
            for (u = 0; (a = this.regexp.exec(e)) && (l = c(a[1].trim()), "string" != typeof l && (l = t(l)), l || (this.logger.warn("missed to pass in variable " + a[1] + " for interpolating " + e), l = ""), l = r(this.escapeValue ? this.escape(l) : l), e = e.replace(a[0], l), this.regexp.lastIndex = 0, !(++u >= this.maxReplaces)); )
              ;
            return e;
            ...
            function o(t) {
              ...
              t = e.shift();
              var n = e.join(",");
              n = this.interpolate(n, a), n = n.replace(/'/g, '"');
              try {
                a = JSON.parse(n);
              } catch (e) {
            ...
            for (a.applyPostProcessor = !1; i = this.nestingRegexp.exec(e); ) {
              if ((s = n(o.call(this, i[1].trim()), a)) && i[0] === e && "string" != typeof s)
                return s;
        ...
        T = function(t) {
          ...
          return m(e, t), e.prototype.queueLoad = function(t, e, n) {
            ...
            var r = v({}, this.backend.options, this.options.backend);
            ...
            r.allowMultiLoading && this.backend.readMulti ? this.read(s.toLoadLanguages, s.toLoadNamespaces, "readMulti", null, null, function(t, e) {
            ...
            var o = v({}, this.backend.options, this.options.backend);
        ...
        H = function(t) {
          ...
          return m(e, t), e.prototype.load = function(t, e, n) {
            ...
            if (!this.cache)
              return n && n();
            var r = v({}, this.cache.options, this.options.cache),
    ...
    return new (function(t) {
      function e() {
        ...
        y(this, e);
        var r = b(this, t.call(this));
        if (r.options = h(n), r.services = {}, r.logger = O, r.modules = {external: []}, o && !r.isInitialized && !n.isClone) {
          var i;
      ...
      return m(e, t), e.prototype.init = function() {
        ...
        if ("function" == typeof n && (o = n, n = {}), this.options = v({}, f(), this.options, h(n)), this.format = this.options.interpolation.format, o || (o = g), !this.options.isClone) {
          ...
          i.logger = O, i.resourceStore = this.store, i.resourceStore.on("added removed", function(t, e) {
          ...
          }), i.interpolator = new M(this.options), i.backendConnector = new T(t(this.modules.backend), i.resourceStore, i, this.options), i.backendConnector.on("*", function(t) {
            ...
            i.cacheConnector.save();
          }), i.cacheConnector = new H(t(this.modules.cache), i.resourceStore, i, this.options), i.cacheConnector.on("*", function(t) {
            for (var n = arguments.length,
                o = Array(n > 1 ? n - 1 : 0),
                r = 1; r < n; r++)
              o[r - 1] = arguments[r];
        ...
        return "backend" === t.type && (this.modules.backend = t), "cache" === t.type && (this.modules.cache = t), ("logger" === t.type || t.log && t.warn && t.error) && (this.modules.logger = t), "languageDetector" === t.type && (this.modules.languageDetector = t), "postProcessor" === t.type && j.addPostProcessor(t), "3rdParty" === t.type && this.modules.external.push(t), this;
        ...
        var n = this,
            ...
            r = function(t) {
              t && (n.language = t, n.languages = n.services.languageUtils.toResolveHierarchy(t), n.services.languageDetector && n.services.languageDetector.cacheUserLanguage(t)), n.loadResources(function(e) {
                o(e, t);
              });
            };
        ...
        var n = this,
            o = function t(e) {
              var o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                  r = "string" == typeof o ? {defaultValue: o} : v({}, o);
              return r.lng = r.lng || t.lng, r.lngs = r.lngs || t.lngs, r.ns = r.ns || t.ns, n.t(e, r);
            };
